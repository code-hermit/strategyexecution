...
Exit: hold for HOLD_MINUTES = 15 minutes, then exit at the first minute at/after that deadline (TIME_EXIT), or at day end if 15:15 arrives first (EOD).
...
HOLD_MINUTES = 15  # how long a triggered buy is held before being time-exited
